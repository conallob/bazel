...
public abstract class BazelLockFileValue implements SkyValue, Postable {
  ...
  public ImmutableList<String> getModuleExtensionDiff(
    ...
    if (lockedExtension == null) {
      return extDiff.add("The module extension '" + extensionId + "' does not exist in the lockfile").build();
    }
    ...
    if (!envVariables.equals(lockedExtension.getEnvVariables())) {
      extDiff.add("The environment variables this extension depends on, or there values have "
          + "changed");
    }
